...
export const CardProvider = ({ provider_name, logo_path }) => {
  ...
  return (
    <div className="w-32 shadow-lg rounded-lg overflow-hidden cursor-pointer transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-105">
