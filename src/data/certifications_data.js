export default {
  certifications: {
    ...
    NL: [
      { certification: "AL", meaning: "All ages.", order: 1 },
      {
        certification: "6",
    ...
    NO: [
      ...
      { certification: "A", meaning: "Suitable for all.", order: 1 },
    ],
    RU: [
      {
        certification: "6+",
      ...
      { certification: "0+", meaning: "All ages are admitted.", order: 1 },
      {
        certification: "16+",
    ...
    IT: [
      ...
      { certification: "T", meaning: "All ages admitted.", order: 1 },
      {
        certification: "VM18",
    ...
    DK: [
      { certification: "11", meaning: "For ages 11 and up.", order: 3 },
      {
        certification: "7",
      ...
      { certification: "15", meaning: "For ages 15 and up.", order: 4 },
      { certification: "F", meaning: "Exempt from classification.", order: 5 },
      { certification: "NR", meaning: "No rating information.", order: 0 },
    ],
    US: [
      {
    ...
    FI: [
      { certification: "K-16", meaning: "Over 16 years.", order: 4 },
      { certification: "K-12", meaning: "Over 12 years.", order: 3 },
      { certification: "K-7", meaning: "Over 7 years.", order: 2 },
      { certification: "S", meaning: "For all ages.", order: 1 },
      { certification: "K-18", meaning: "Adults only.", order: 5 },
      {
        certification: "KK",
    ...
    ES: [
      ...
      { certification: "APTA", meaning: "General admission.", order: 1 },
      {
        certification: "18",
    ...
    SE: [
      ...
      { certification: "Btl", meaning: "All ages.", order: 1 },
    ],
    HU: [
      {
        certification: "6",
      ...
      { certification: "KN", meaning: "Without age restriction.", order: 1 },
      {
        certification: "18",
    ...
    BG: [
      { certification: "A", meaning: "Recommended for children.", order: 1 },
      { certification: "B", meaning: "Without age restrictions.", order: 2 },
      {
        certification: "X",
